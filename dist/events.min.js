...
const { MinHeap } = __webpack_require__(25);
const { MaxHeap } = __webpack_require__(26);
const { CustomHeap } = __webpack_require__(27);
...
const { CustomHeap } = __webpack_require__(2);
...
var _priorityQueue = __webpack_require__(23);
...
var _registerSlots = __webpack_require__(8);
...
var _MySessionsSection = __webpack_require__(13);

var _MySessionsSection2 = _interopRequireDefault(_MySessionsSection);

var _SpeakerSection = __webpack_require__(14);

var _SpeakerSection2 = _interopRequireDefault(_SpeakerSection);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function registerEventSlots() {
    (0, _registry.registerSlot)('filters:left:afterMyFavorites', _MySessionsSection2.default);
    (0, _registry.registerSlot)('card:content:afterText', _SpeakerSection2.default);
}
...
var _SpeakerModal = __webpack_require__(20);

var _SpeakerModal2 = _interopRequireDefault(_SpeakerModal);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function SpeakerLink(_ref) {
    var name = _ref.name,
    ...
    var jobTitle = speaker.globalJobtitle || speaker.jobTitle || '';
    var company = speaker.companyName || '';
    var bioHtml = speaker.description || '';
    var sessions = speaker.speakerSessions || [];
    var style = { background: 'none', border: 'none', padding: 0, color: '#1473e6', cursor: 'pointer' };
    return _react2.default.createElement(
        _react.Fragment,
        null,
        _react2.default.createElement(
        ...
        open && modalContainer && (0, _reactDom.createPortal)(_react2.default.createElement(
            'div',
            { onClick: function onClick(e) {
                    if (e.target.classList && e.target.classList.contains('dexter-Modal_overlay')) setOpen(false);
                } },
            _react2.default.createElement(_SpeakerModal2.default, { name: name, jobTitle: jobTitle, company: company, bioHtml: bioHtml, sessions: sessions })
        ), modalContainer)
    );
}

var SpeakerSection = function SpeakerSection(_ref2) {
    var card = _ref2.card;

    var speakers = card && card.search && Array.isArray(card.search.speakers) ? card.search.speakers : [];
    if (!speakers.length) return null;
    return _react2.default.createElement(
        'div',
        { className: 'events-speakers', style: { marginTop: '6px' } },
        speakers.map(function (sp, i) {
            return _react2.default.createElement(
                'span',
                { key: sp.speakerId || sp.globalFullName || i },
                _react2.default.createElement(SpeakerLink, { name: sp.globalFullName || sp.name || 'Speaker', speaker: sp }),
                i < speakers.length - 1 ? ', ' : ''
            );
        })
    );
...
exports.default = (0, _react.memo)(SpeakerSection);
...
var _prettyFormat = __webpack_require__(21);
...
/* eslint-disable */
var SpeakerModal = function SpeakerModal(_ref) {
    var name = _ref.name,
        jobTitle = _ref.jobTitle,
        company = _ref.company,
        bioHtml = _ref.bioHtml,
    ...
    var fmt = function fmt(s, e) {
        return s ? (0, _prettyFormat2.default)(s, e, locale, i18nFormat) : '';
    };
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'dexter-Modal mobile-width-100 tablet-width-640 desktop-width-1024 is-Open' },
                _react2.default.createElement(
                    'div',
                    ...
                    jobTitle && _react2.default.createElement(
                        'div',
                        null,
                        jobTitle
                    ),
                    ...
                    Array.isArray(sessions) && sessions.length > 0 && _react2.default.createElement(
                        'div',
                        { style: { margin: '12px 0' } },
                        sessions.map(function (s) {
                            return _react2.default.createElement(
                                'div',
                                { key: '' + (s.sessionId || s.sessionCode || s.sessionTitle), style: { marginBottom: '10px' } },
                                _react2.default.createElement(
                                    'div',
                                    null,
                                    _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    null,
                                    fmt(s.sessionStartTime, s.sessionEndTime)
                                ),
                                _react2.default.createElement(
                                    'div',
                                    null,
                    ...
                    bioHtml && _react2.default.createElement('div', {
...
var _consonant = __webpack_require__(29);

var _contexts = __webpack_require__(30);
...
const { MinPriorityQueue } = __webpack_require__(24);
const { MaxPriorityQueue } = __webpack_require__(28);
const { PriorityQueue } = __webpack_require__(4)
...
const { MinHeap } = __webpack_require__(2);
const { PriorityQueue } = __webpack_require__(4);
...
const { Heap } = __webpack_require__(3);
...
const { MaxHeap } = __webpack_require__(2);
const { PriorityQueue } = __webpack_require__(4);
