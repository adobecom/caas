...
async function renderScenario(context, routeLibraries, plan) {
  ...
  const _mobile = plan.viewport === 'mobile';
  await page.setViewportSize(_mobile ? { width: 390, height: 844 } : { width: 1280, height: 1800 });
  if (_mobile) console.log('[viewport] mobile 390x844 (window.innerWidth < 1200 -> isMobile true)');
